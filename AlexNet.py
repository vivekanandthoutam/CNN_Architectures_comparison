...
model.load_weights("C:\\Users\\16028\\Downloads\\archive (2)\\best_weights_9.hdf5")
...
# checkpoint_filepath = f'Trained model2'
...
# plt.show()
"""Model Accuracy"""
model = tf.keras.models.load_model("Trained model alexnet") 
